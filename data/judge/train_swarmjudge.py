"""
SwarmJudge-7B Training Script
===============================

Standalone training script for whale rig (single RTX 3090, 24GB).
QLoRA NF4 on Qwen2.5-7B-Instruct via Unsloth.

Usage:
    python3 train_swarmjudge.py [--dry-run] [--max-samples N]
"""
...
OUTPUT_DIR = Path("/home/swarm/swarmjudge-7b")
DATA_DIR = Path("/home/swarm/swarmjudge_data")
...
def main():
    ...
    print(f"SwarmJudge-7B Training")
    print(f"{'='*50}")
    ...
    if args.dry_run:
        ...
        print(f"  Estimated time: ~{total_steps * 8 / 3600:.1f}h @ ~8s/step")
        return
